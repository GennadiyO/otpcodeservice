...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.igwines"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("OTP Code Service API")
                .contact(new Contact("Demo", "github.com", "demo@demo.com"))
                .description("")
